...
public class OneAdapter extends BaseRecyclerViewAdapter<HotMovieBean.SubjectsBean> {
    ...
    private class ViewHolder extends BaseRecyclerViewHolder<HotMovieBean.SubjectsBean, ItemOneBinding> {
        ...
        @Override
        public void onBindViewHolder(final HotMovieBean.SubjectsBean bean, int position) {
            if (bean != null) {
                binding.setBean(bean);
                binding.viewLine.setBackgroundColor(CommonUtils.randomColor());
